...
struct sfRunner {
    ...
    sfSprite *spriteEnemy3;
    sfSprite *spriteBackground;
    sfSprite *spriteSky;
    sfSprite *spriteGround;
    sfSprite *spritePlatform;
    sfSprite *spritePlatform2;
    sfSprite *spritePlatform3;
    sfSprite *spriteDead;
    sfSprite *spriteEnd;
    ...
    sfVector2f positionPlatform2;
    sfVector2f positionPlatform3;
...
void change_size_fullscreen(struct sfRunner *);
